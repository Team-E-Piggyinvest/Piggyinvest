<?php
  require_once('amadikwajoy/interestrate.php');
...
<title>:: Piggyinvest Interest Calculator ::</title>
...
<nav class="navbar clearHeader">
    <div class="col-12">
        <div class="navbar-header"> <a href="javascript:void(0);" class="bars"></a> <a class="navbar-brand" href="index-2.html">PiggyVest Interest Calculator</a> </div>
    ...
    <aside id="leftsidebar" class="sidebar"> 
        ...
        <div class="menu">
            <ul class="list">
                ...
                <li class="active open"><a href="home.html"><i class="zmdi zmdi-home"></i><span>Dashboard</span></a></li>     
        </div>
        <!-- #Menu -->
    </aside>
    <!-- #END# Left Sidebar --> 
...
<section class="content home">
    <div class="container-fluid">
        <div class="block-header">
            <h2>Dashboard</h2>
            <small class="text-muted">Welcome to PiggyVest Interest Calculation application</small>
        </div>
        ...
        <div class="row clearfix top-report">
            <div class="col-lg-3 col-sm-6 col-md-6">
                <div class="card">
                    <div class="body">
                        <h3>1,100</h3>
                        <p class="text-muted">flex  Naiara</p>
                        ...
                        <span class="text-small">10% Interest Rate</span> </div>
                </div>
            </div>
            <div class="col-lg-3 col-sm-6 col-md-6">
                <div class="card">
                    <div class="body">
                        <h3>60,800</h3>
                        <p class="text-muted">Flex Dollar</p>
                        <div class="progressbar-xs progress-rounded progress-striped progress ng-isolate-scope">
            ...
            <div class="col-lg-3 col-sm-6 col-md-6">
                <div class="card">
                    <div class="body">
                        ...
                        <span class="text-small">all packages  at10% Interest Rate </span> </div>
                </div>
            </div>            
        </div> 
        <div class="row clearfix">
			<div class="col-lg-12 col-md-12 col-sm-12">
                <form action="" method="post">
                    <div class="card">
                        <div class="header">
                            <h2>Interest calculator  <small>Description text here...</small> </h2>
                            ...
                            <div class="row clearfix">
                                <div class="col-lg-4 col-md-6 col-sm-12">
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="text" name= "damount" class="form-control" placeholder="Enter Your Desired Amount ">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-4 col-md-6 col-sm-12">
                                ...
                                <div class="col-lg-4 col-md-6 col-sm-12">
                                    <div class="form-group drop-custum">
                                        <select class="form-control show-tick" name="packages">
                                            <option value="">-- packages  --</option>
                                            <option value="10">Piggybank</option>
                                            <option value="20">Target Savings</option>
                                            <option value="30">Flex Naira</option>
                                            <option value="40">Flex Dollar </option>
                                        </select>
                                    </div>
                                </div> 
                                ...
                                <div class="col-sm-12">
                                    <button type="submit" name="calculate" class="btn btn-raised g-bg-blush2">Calculate</button>
        ...
        <div class="row clearfix">
            <div class="col-lg-4 col-md-12 col-sm-12">
                    ...
                    <p><?php echo $principal_rate ?></p>
                    
                    <strong>package</strong>
                    <p>Flex dollar </p>
                    <strong>duration </strong>
                    <p> <?php echo $periods_of_investment ?> year(s) </p>
                    <strong>Worth</strong>
                    <!-- <p>50000</p> -->
                    <hr>
                    <strong>profit </strong>
                    <address><?php echo $total_interest ?></address>
                    </div>
            </div>
                ...
                <div class="card">
                    <div class="body"> 
                        ...
                        <ul class="nav nav-tabs" role="tablist">
                            <li class="nav-item"><a class="nav-link active" data-toggle="tab" href="#report">About </a></li>
                        </ul>
                            ...
                            <div role="tabpanel" class="tab-pane in active" id="report">
                                <div class="wrap-reset">
                                    <div class="mypost-list">
                                        <div class="post-box">
                                            <p> 10% per annum on Piggybank <br>
                                                Up to 15.5% per annum on SafeLock <br>
                                                10% per annum on Target <br>
                                                10% per annum on Flex <br>
                                                6% per annum on Flex Dollar <br>
                                                Up to 25% on Investify <br>
                                                Kindly note that interest rates are subject to change at any time based on market conditions. 
                                            </p>
                                            <p> How is my interest paid?
        ...
        <div class="row clearfix">
            <div class="col-sm-12 col-md-4 col-lg-4">
                <div class="card">
                    <div class="header">
                        <h2>Moses <small >All Earnings are in million $</small></h2>
                        <ul class="header-dropdown">
                            <li class="dropdown"> <a href="javascript:void(0);" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><i class="zmdi zmdi-more-vert"></i></a>
                                <ul class="dropdown-menu pull-right">
                                    <li><a href="javascript:void(0);">Action</a></li>
...
<!-- Mirrored from thememakker.com/templates/swift/university/ by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 20 Oct 2019 12:27:04 GMT -->
</html>
